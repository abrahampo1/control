		...
		<div class="content">
			<div class="container-xl">
				<div class="page-header d-print-none">
				  ...
				  <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#hacer-cambio" aria-label="Create new report">
				  Camb.
                  </a>
				  <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#auditar" aria-label="Create new report">
				  Aud.
                  </a>
                  <a href="#" class="btn btn-danger d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-report" aria-label="Create new report">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
                  </a>');
								}
								?>
				  ...
				  <div class="col-12">
					  ...
					  <tbody>');
							...
							while ($row = mysqli_fetch_assoc($do)) {
								$num_operario = $row["encargado"];
								$sql = "SELECT * FROM usuarios WHERE id = '$num_operario'";
								$buscar = mysqli_query($link, $sql);
								$datos_operador = mysqli_fetch_assoc($buscar);
								$semana = date('W', $row["unix"]);
								$fecha = date('Y-m-d G:i', $row["unix"]);
								echo ('<tr>
					  ...
					  <div class="col-sm-6 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="d-flex align-items-baseline">
									<div class="h1 mb-0 me-2">' . $reportes_totales . '</div>
									<div class="me-auto">
									</div>
								</div>
							</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="d-flex align-items-baseline">
									<div class="h1 mb-3 me-2">' . $auditorias_totales . '</div>
									<div class="me-auto">
									</div>
								</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="d-flex align-items-baseline">
									<div class="h1 mb-3 me-2">' . $ausencias_totales . '</div>
									<div class="me-auto">
									</div>
								</div>
				...
				<br>
				<?php if (isset($_SESSION["turno"]) && $info_usuario["tipo"] != "supervisor") {
		...
		<div class="container">
			<div class="row align-items-center flex-row-reverse">
				...
				<div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
					V.10.2.21 Copyright © 2021 <a href="mailto:abraham@cpsoftware.es">CPSoftware</a>. </a>El programa ha sido creado por Abraham Leiro Fernandez y Rubén Bendaña Couse.
				</div>
			</div>
		</div>
	</footer>
