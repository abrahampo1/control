		...
		<div class="content">
			<div class="container-xl">
				...
				<div class="row align-items-center">
					<div class="col">
						<!-- Page pre-title -->
						<div class="d-print-none col-auto btn-list">
							<div class=""><button class="btn btn-primary d-none d-sm-inline-block" onclick="goBack()">Retroceder</button></div>
							<div class=""><button class="btn btn-primary d-none d-sm-inline-block" onclick="window.print();return false;">Imprimir</button></div>
							<div class=""><a href="mail.php" class="btn btn-primary d-none d-sm-inline-block">Enviar Mail</a></div>
						</div> <br>
